...
class ItemViewModel: Identifiable, ObservableObject {
    ...
    @Published var weightUnit: ItemWeightUnit = .None
    @Published var weight: Float = 0
    
    @Published var priceType: ItemPriceType = .Fixed
    @Published var price: Int16 = 0
    @Published var quantity: Int16 = 0

    @Published var discountType: ItemDiscountType = .Fixed
    @Published var discountValue: Float = 0
